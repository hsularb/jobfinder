...
@section ("header")
    ...
    <a href="{{ route('location.create') }}" type="button">Add New</a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="td-actions text-right">
                        ...
                        <a type="button" href="{{ route('location.edit',$value->id) }}" rel="tooltip" class="btn btn-success btn-icon btn-sm btn-round" data-original-title="" title="">
                          <i class="now-ui-icons ui-2_settings-90"></i>
                        </a>

                        <form action="{{ route('location.destroy', $value->id) }}" method="post" style="display:inline-block;" class ="delete-form">
                          @csrf
                          @method('delete')
